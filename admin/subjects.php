    ...
    <div class="layout">
        ...
        <main>
            ...
            <div class="admin-container">
                ...
                <main class="content_subjects">
                    <div class="header-section">
                        <h1><span class="material-icons">groups</span>Subjects Administration</h1>
                        <div class="search-add">
                            ...
                            <button class="add-btn" id="addSubjectBtn">
                                <span class="material-icons">add</span><p>New Subject</p>
                            </button>
                        </div>
                    </div>
                ...
                <!-- Modal para agregar/editar subject -->
                <div class="modal" id="subjectModal">
                    <div class="modal-content">
                        <span class="close-modal" style="display: none;">&times;</span>
                        <h2 id="modalTitle">New subject</h2>
                        <form id="subjectForm" class="formsubjects">
                            <div class="form-group">
                                <label for="subjectName">Subject Name</label>
                                <input type="text" id="subjectName" required placeholder="Ex. Network">
