    ...
    <div class="layout">
        ...
        <main>
            ...
            <div class="admin-container">
                ...
                <main class="content_classrooms">
                    <div class="header-section">
                        <h1><span class="material-icons">groups</span>Classrooms Administration</h1>
                        <div class="search-add">
                            <div class="search-box2">
                                <select id="searchType" class="searchTypes">
                                    <option value="group">Search Group</option>
                                    <option value="classroom">Search Classroom</option>
                                </select>
                                <input type="text" id="searchInput" placeholder="Search...">
                                <button class="search-btn"><span class="material-icons">search</span></button>
                            </div>
                            <button  class="add-btn" onclick="openModal(null, 'group')"><span class="material-icons">add</span><p>New Group</p></button>
                            <button  class="add-btn" onclick="openModal(null, 'classroom')"><span class="material-icons">add</span><p>New Classroom</p></button>
                ...
                <div class="modal" id="classroomModal">
                    <div class="modal-content">
                        ...
                        <h2 id="modalTitle">New Changes</h2>
                        <form id="classroomForm" class="formClassrooms" novalidate>
                            <!--
                            <div class="form-group">
                                <label for="classroomGroup">Group</label>
                                <input type="number" id="classroomGroup" class="input-office" required minlength="3" maxlength="6" placeholder="Ex. 6CV3">
                                <div class="error-message" id="officeError"></div>
                            </div>
                            <div class="form-group">
                                <label for="classroomName">Classroom</label>
                                <input type="number" id="classroomName" required minlength="3" maxlength="6" placeholder="Ex. 2222">
                                <div class="error-message" id="nameError"></div>
                            </div>!-->
                            <div class="form-group group-field">
                                <label for="classroomGroup">Group</label>
                                <input type="text" id="classroomGroup" class="input-office" required minlength="3" maxlength="6" placeholder="Ex. 6CV3">
                                <div class="error-message" id="officeError"></div>
                            </div>

                            <div class="form-group classroom-field">
                                <label for="classroomName">Classroom</label>
                                <input type="text" id="classroomName" required minlength="3" maxlength="6" placeholder="Ex. 2222">
                                <div class="error-message" id="nameError"></div>
                            </div>
